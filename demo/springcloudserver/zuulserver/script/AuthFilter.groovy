...
class AuthFilter extends ZuulFilter {
    List<String> WHITE_URL_LIST = Arrays.asList(["users/auth/login", "validation", "getToken", "/clusters", "system/configs/trialtime", "cicd/trigger/webhookTrigger", "users/auth/token", "/testcallback"] as String[]);
    String allowOrigin = '*'
